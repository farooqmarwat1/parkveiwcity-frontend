        ...
        >
          ...
          <div className="mt-9 flex flex-col items-start gap-4 sm:flex-row">
            <button
              ...
              className="flex h-[44px] min-w-[160px] items-center justify-center gap-2 rounded-full border border-[#58595B]/40 bg-white px-8 font-roboto text-[12px] font-medium leading-[18px] tracking-[3.3px] uppercase text-[#58595B] transition-all duration-300 hover:border-[#C4973A] hover:text-[#C4973A] cursor-pointer"
            >
              View Properties
            </button>
            <button
